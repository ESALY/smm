...
Официальный сайт Продукта: http://simplacms.ru
	...
	print "<p><form method=get><input type='hidden' name='step' value='test'><input type='submit' value='С соглашением согласен, начать установку →'></form></p>";
}
...
function testserver()
{
	...
	print "<p>Проверка прошла успешно. ";
	print "Сейчас мы разархивируем файлы в папку<br><code>$current_dir</code></p>";
	print "<p><b>Все файлы в этой папке будут удалены безвозвратно!</b></p>";
...
function unzip()
{
	...
	print "<p>Файлы успешно распакованы в папку<br><code>$current_dir</code></p>";
